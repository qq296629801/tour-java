package cn.ymsys.authentication;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    @Autowired
    private LambdaPortalProperties properties;
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        if (StringUtils.isBlank(encryptTokenInRedis)) {
            ...
            try {
                this.redisService.pexpireAt(PortalConstant.ACTIVE_USERNAMES_SET_PREFIX + StringUtils.lowerCase(username), System.currentTimeMillis() + properties.getShiro().getJwtTimeOut() * 1000);
                this.redisService.pexpireAt(PortalConstant.TOKEN_CACHE_PREFIX + encryptToken + "." + ip,
                        System.currentTimeMillis() + properties.getShiro().getJwtTimeOut() * 1000);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
